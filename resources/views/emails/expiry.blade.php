        ...
        <div style="max-width: 680px; width: 100%; margin-top: 5px;">
            ...
            <div style="background-color: #fbfcfd; border-top: thick double #cccccc; text-align: left; width: 100%;">
                <div style="padding: 20px; width: 100%;">
                    <p style="width: 80%;">
                        Dear {{$data['to_name']}},<br> <br> Thanks for using Little Prodigy Books for the past Year we love having you as our customer.</p>

                    <p>Your plan will expire today, so we thought we’d check in. If you want to continue taking advantage of books, you can easily renew by going to our <a href="www.littleprodigybook.in">website</a>
